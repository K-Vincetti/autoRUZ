...
CREATE INDEX hw_ads_costof_btree
ON service.ads USING btree(costof);

CREATE INDEX hw_ads_status_btree
ON service.ads USING btree(status);

CREATE INDEX hw_ads_headertext_btree
ON service.ads USING btree(headertext);

CREATE INDEX hw_ads_sellerid_btree
ON service.ads USING btree(sellerid);
